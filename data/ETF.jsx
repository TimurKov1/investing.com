import { ETFList } from './Data'
import axios from 'axios'

export async function fetchETFRating(setTables, setPrices, setColor, prices, isMobile) {
    ...
    const options = {
      method: 'POST',
      url: 'https://investing4.p.rapidapi.com/etfs/overview',
      headers: {
    ...
    const serverData = responce.data.data.filter(item => ETFList.indexOf(item.symbol) != -1)
    const tables = []
    const priceData = []
    const colors = []
    var count = 0
