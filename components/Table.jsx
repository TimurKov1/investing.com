...
const Table = ({columns, tables, width = 'auto', type = '', className = '', fake, colors}) => {
    return (
        <>
            {fake ?
                ...
                <table className={styles.table + ' ' + className}>
                    ...
                    {tables.map((item, indexMain) => <tr key={indexMain} className={styles.tr}>
                        {type === '1' ?
                            <>
                                <td className={styles.td + ' ' + styles.item + ' ' + styles.flex} style={{
                                ...
                                {item.map((text, index) =>
                                    text === item[0] ? '' :
                                        <td key={index} className={styles.td + ' ' + styles.item} style={{
                                            color: columns[index] == 'цена' ? colors[indexMain] : text.includes('+') ? '#23C14F' : text.includes('-') ? '#FF4545' : '#433532',
                                            textTransform: 'uppercase', width
                                        }}>
                                            {text}
                                        </td>)}
